...
def get_ipa_file_path():
    #工作目录下面的 ipa 文件/Users/ljj/.jenkins/jobs/PgyerDemo/workspace/product
    ipa_file_workspace_path = '/Users/ljj/.jenkins/jobs/' + project_name + '/workspace/product/' + '****' + '.ipa'
    #tomcat 上的 ipa 文件
